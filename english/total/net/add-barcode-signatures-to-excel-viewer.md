...
############################# Head ############################
head_title: "Add Barcode Signatures to Excel Viewer in C# .NET"
head_description: "Add 60+ digital barcode signatures to Excel spreadsheets and 100+ other file formats. View the signed file in HTML using GroupDocs.Total for .NET APIs."

############################# Header ############################
title: "Add Barcode Signatures to Excel Viewer"
description: "Digitally sign and secure Excel spreadsheet formats by adding 60+ barcode signature types in your C#, .NET or VB.NET applications using GroupDocs.Total APIs."
...
steps:
    enable: true
    title_left: "Adding barcode signatures to Excel file in .NET"
    content_left: |
