...
############################# Head ############################
head_title: "Add JPG Image Watermark to PS Viewer in C# .NET"
head_description: "C# .NET API to add JPG image watermark into Adobe PostScript (PS) file and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add JPG Image Watermark to PS Viewer"
description: "Insert JPG or any other image watermark into Adobe PostScript (PS) files quite easily and accurately using GroupDocs.Total suite of documents automation APIs for C# .NET applications."
...
steps:
    ...
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/net/) makes it easy for developers to integrate JPG image watermark into Adobe PostScript (PS) file using a few lines of C# .NET code.
