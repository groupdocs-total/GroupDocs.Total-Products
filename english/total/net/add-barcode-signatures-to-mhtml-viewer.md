...
############################# Head ############################
head_title: "Add Barcode Signatures to MHTML Viewer in C# .NET"
head_description: "Add 60+ digital barcode signatures to a web page archive format (MHTML) and 100+ other file formats. View the signed file in HTML using GroupDocs.Total for .NET APIs."

############################# Header ############################
title: "Add Barcode Signatures to MHTML Viewer"
description: "Digitally sign and secure a web page archive format (MHTML) by adding 60+ barcode signature types in your C#, .NET or VB.NET applications using GroupDocs.Total APIs."
...
steps:
    enable: true
    title_left: "Adding barcode signatures to MHTML file in .NET"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/net/) makes it easy for developers to digitally sign a web page archive format (MHTML) with barcode signatures using a few lines of C# .NET code.
    ...
    code: |
        ```cs
        // Add barcode signature to MHTML file using GroupDocs.Signature API
        ...
        using (Signature signature = new Signature("input.mhtml"))
          ...
          SignResult result = signature.Sign("output.mhtml", options);
