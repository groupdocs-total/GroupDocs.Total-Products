...
############################# Head ############################
head_title: "Add JP2 Image Watermark to VSTX Viewer in C# .NET"
head_description: "C# .NET API to add JP2 image watermark into Microsoft Visio Drawing Template (VSTX) and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add JP2 Image Watermark to VSTX Viewer"
description: "Insert JP2 or any other image watermark into Microsoft Visio Drawing Template (VSTX) files quite easily and accurately using GroupDocs.Total suite of documents automation APIs for C# .NET applications."
...
steps:
    ...
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/net/) makes it easy for developers to integrate JP2 image watermark into Microsoft Visio Drawing Template (VSTX) documents using a few lines of C# .NET code.
