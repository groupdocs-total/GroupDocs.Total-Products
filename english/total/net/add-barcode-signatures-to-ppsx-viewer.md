...
############################# Head ############################
head_title: "Add Barcode Signatures to PPSX Viewer in C# .NET"
head_description: "Add 60+ digital barcode signatures to PowerPoint Slide Show (PPSX) format and 100+ other file formats. View the signed file in HTML using GroupDocs.Total for .NET APIs."

############################# Header ############################
title: "Add Barcode Signatures to PPSX Viewer"
description: "Digitally sign and secure PowerPoint Slide Show (PPSX) format by adding 60+ barcode signature types in your C#, .NET or VB.NET applications using GroupDocs.Total APIs."
...
steps:
    enable: true
    title_left: "Adding barcode signatures to PPSX file in .NET"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/net/) makes it easy for developers to digitally sign PowerPoint (PPSX) files with barcode signatures using a few lines of C# .NET code.
    ...
    code: |
        ```cs
        // Add barcode signature to PPSX file using GroupDocs.Signature API
        ...
        using (Signature signature = new Signature("input.ppsx"))
          ...
          SignResult result = signature.Sign("output.ppsx", options);
