...
############################# Head ############################
head_title: "Add Barcode Signatures to SXC Viewer in C# .NET"
head_description: "Add 60+ digital barcode signatures to Excel spreadsheet (SXC) formats and 100+ other file formats. View the signed file in HTML using GroupDocs.Total for .NET APIs."

############################# Header ############################
title: "Add Barcode Signatures to SXC Viewer"
description: "Digitally sign and secure Excel spreadsheet (SXC) formats by adding 60+ barcode signature types in your C#, .NET or VB.NET applications using GroupDocs.Total APIs."
...
steps:
    enable: true
    title_left: "Adding barcode signatures to SXC file in .NET"
    content_left: |
    ...
    code: |
        ```cs
        // Add barcode signature to SXC file using GroupDocs.Signature API
        ...
        using (Signature signature = new Signature("input.sxc"))
          ...
          SignResult result = signature.Sign("output.sxc", options);
