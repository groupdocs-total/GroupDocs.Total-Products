...
############################# Head ############################
head_title: "Add Barcode Signatures to VSDX Viewer in C# .NET"
head_description: "Add 60+ digital barcode signatures to Microsoft Visio Drawing files (VSDX) and 100+ other file formats. View the signed file in HTML using GroupDocs.Total for .NET APIs."

############################# Header ############################
title: "Add Barcode Signatures to VSDX Viewer"
description: "Digitally sign and secure Microsoft Visio Drawing files (VSDX) by adding 60+ barcode signature types in your C#, .NET or VB.NET applications using GroupDocs.Total APIs."
...
steps:
    enable: true
    title_left: "Adding barcode signatures to VSDX file in .NET"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/net/) makes it easy for developers to digitally sign Microsoft Visio Drawing (VSDX) documents with barcode signatures using a few lines of C# .NET code.
    ...
    code: |
        ```cs
        // Add barcode signature to VSDX file using GroupDocs.Signature API
        ...
        using (Signature signature = new Signature("input.vsdx"))
          ...
          SignResult result = signature.Sign("output.vsdx", options);
