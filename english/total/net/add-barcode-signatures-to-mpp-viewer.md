...
############################# Head ############################
head_title: "Add Barcode Signatures to MPP Viewer in C# .NET"
head_description: "Add 60+ digital barcode signatures to Microsoft Project (MPP) and 100+ other file formats. View the signed file in HTML using GroupDocs.Total for .NET APIs."

############################# Header ############################
title: "Add Barcode Signatures to MPP Viewer"
description: "Digitally sign and secure Microsoft Project data files (MPP) by adding 60+ barcode signature types in your C#, .NET or VB.NET applications using GroupDocs.Total APIs."
...
steps:
    enable: true
    title_left: "Adding barcode signatures to MPP file in .NET"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/net/) makes it easy for developers to digitally sign Microsoft Project data documents (MPP) with barcode signatures using a few lines of C# .NET code.
    ...
    code: |
        ```cs
        // Add barcode signature to MPP file using GroupDocs.Signature API
        ...
        using (Signature signature = new Signature("input.mpp"))
          ...
          SignResult result = signature.Sign("output.mpp", options);
