...
############################# Head ############################
head_title: "Add Barcode Signatures to VDX Viewer in C# .NET"
head_description: "Add 60+ digital barcode signatures to Microsoft Visio Drawing XML file (VDX) and 100+ other file formats. View the signed file in HTML using GroupDocs.Total for .NET APIs."

############################# Header ############################
title: "Add Barcode Signatures to VDX Viewer"
description: "Digitally sign and secure Microsoft Visio Drawing XML file (VDX) by adding 60+ barcode signature types in your C#, .NET or VB.NET applications using GroupDocs.Total APIs."
...
steps:
    enable: true
    title_left: "Adding barcode signatures to VDX file in .NET"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/net/) makes it easy for developers to digitally sign Microsoft Visio Drawing XML documents (VDX) with barcode signatures using a few lines of C# .NET code.
    ...
    code: |
        ```cs
        // Add barcode signature to VDX file using GroupDocs.Signature API
        ...
        using (Signature signature = new Signature("input.vdx"))
          ...
          SignResult result = signature.Sign("output.vdx", options);
