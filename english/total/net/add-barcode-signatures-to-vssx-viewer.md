...
############################# Head ############################
head_title: "Add Barcode Signatures to VSSX Viewer in C# .NET"
head_description: "Add 60+ digital barcode signatures to Microsoft Visio Stencil (VSSX) and 100+ other file formats. View the signed file in HTML using GroupDocs.Total for .NET APIs."

############################# Header ############################
title: "Add Barcode Signatures to VSSX Viewer"
description: "Digitally sign and secure Microsoft Visio Stencil (VSSX) files by adding 60+ barcode signature types in your C#, .NET or VB.NET applications using GroupDocs.Total APIs."
...
steps:
    enable: true
    title_left: "Adding barcode signatures to VSSX file in .NET"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/net/) makes it easy for developers to digitally sign Microsoft Visio Stencil (VSSX) documents with barcode signatures using a few lines of C# .NET code.
    ...
    code: |
        ```cs
        // Add barcode signature to VSSX file using GroupDocs.Signature API
        ...
        using (Signature signature = new Signature("input.vssx"))
          ...
          SignResult result = signature.Sign("output.vssx", options);
