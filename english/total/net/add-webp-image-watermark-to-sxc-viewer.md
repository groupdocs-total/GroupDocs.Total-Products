...
############################# Head ############################
head_title: "Add WebP Image Watermark to SXC Viewer in C# .NET"
head_description: "C# .NET API to add WebP image watermark into Excel spreadsheet (SXC) formats and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add WebP Image Watermark to SXC Viewer"
description: "Insert WebP or any other image watermark into Excel spreadsheet (SXC) formats quite easily and accurately using GroupDocs.Total suite of documents automation APIs for C# .NET applications."
