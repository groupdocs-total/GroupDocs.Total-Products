...
############################# Head ############################
head_title: "Add GIF Image Watermark to XLT Viewer in C# .NET"
head_description: "C# .NET API to add GIF image watermark into Excel spreadsheet (XLT) formats and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add GIF Image Watermark to XLT Viewer"
description: "Insert GIF or any other image watermark into Excel spreadsheet (XLT) formats quite easily and accurately using GroupDocs.Total suite of documents automation APIs for C# .NET applications."
