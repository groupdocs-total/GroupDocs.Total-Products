...
############################# Head ############################
head_title: "Add GIF Image Watermark to VSD Viewer in C# .NET"
head_description: "C# .NET API to add GIF image watermark into Microsoft Visio Drawing files (VSD) and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add GIF Image Watermark to VSD Viewer"
description: "Insert GIF or any other image watermark into Microsoft Visio Drawing files (VSD) quite easily and accurately using GroupDocs.Total suite of documents automation APIs for C# .NET applications."
...
steps:
    ...
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/net/) makes it easy for developers to integrate GIF image watermark into Microsoft Visio Drawing (VSD) documents using a few lines of C# .NET code.
