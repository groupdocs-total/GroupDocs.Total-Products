...
############################# Head ############################
head_title: "Add Barcode Signatures to VST Viewer in C# .NET"
head_description: "Add 60+ digital barcode signatures to Microsoft Visio Vector Image (VST) and 100+ other file formats. View the signed file in HTML using GroupDocs.Total for .NET APIs."

############################# Header ############################
title: "Add Barcode Signatures to VST Viewer"
description: "Digitally sign and secure Microsoft Visio Vector Image (VST) files by adding 60+ barcode signature types in your C#, .NET or VB.NET applications using GroupDocs.Total APIs."
...
steps:
    enable: true
    title_left: "Adding barcode signatures to VST file in .NET"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/net/) makes it easy for developers to digitally sign Microsoft Visio Vector Image (VST) documents with barcode signatures using a few lines of C# .NET code.
    ...
    code: |
        ```cs
        // Add barcode signature to VST file using GroupDocs.Signature API
        ...
        using (Signature signature = new Signature("input.vst"))
          ...
          SignResult result = signature.Sign("output.vst", options);
