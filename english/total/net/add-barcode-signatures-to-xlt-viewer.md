...
############################# Head ############################
head_title: "Add Barcode Signatures to XLT Viewer in C# .NET"
head_description: "Add 60+ digital barcode signatures to Excel spreadsheet (XLT) formats and 100+ other file formats. View the signed file in HTML using GroupDocs.Total for .NET APIs."

############################# Header ############################
title: "Add Barcode Signatures to XLT Viewer"
description: "Digitally sign and secure Excel spreadsheet (XLT) formats by adding 60+ barcode signature types in your C#, .NET or VB.NET applications using GroupDocs.Total APIs."
...
steps:
    enable: true
    title_left: "Adding barcode signatures to XLT file in .NET"
    content_left: |
    ...
    code: |
        ```cs
        // Add barcode signature to XLT file using GroupDocs.Signature API
        ...
        using (Signature signature = new Signature("input.xlt"))
          ...
          SignResult result = signature.Sign("output.xlt", options);
