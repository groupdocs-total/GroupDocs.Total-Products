...
############################# Head ############################
head_title: "Add BMP Image Watermark to XLSX File in C# .NET"
head_description: "C# .NET API to add BMP image watermark into Excel spreadsheet (XLSX) and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add BMP Image Watermark to XLSX in .NET"
description: "Insert BMP or any other image watermark into Excel spreadsheet (XLSX) formats quite easily and accurately using GroupDocs.Total suite of documents automation APIs for C# .NET applications."
...
steps:
    ...
    code: |
        ```cs
        // Add watermark to Excel Worksheet (XLSX) file using GroupDocs.Watermark API
