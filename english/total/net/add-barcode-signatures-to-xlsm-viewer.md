...
############################# Head ############################
head_title: "Add Barcode Signatures to XLSM Viewer in C# .NET"
head_description: "Add 60+ digital barcode signatures to Excel spreadsheet (XLSM) formats and 100+ other file formats. View the signed file in HTML using GroupDocs.Total for .NET APIs."

############################# Header ############################
title: "Add Barcode Signatures to XLSM Viewer"
description: "Digitally sign and secure Excel spreadsheet (XLSM) formats by adding 60+ barcode signature types in your C#, .NET or VB.NET applications using GroupDocs.Total APIs."
...
steps:
    enable: true
    title_left: "Adding barcode signatures to XLSM file in .NET"
    content_left: |
    ...
    code: |
        ```cs
        // Add barcode signature to XLSM file using GroupDocs.Signature API
        ...
        using (Signature signature = new Signature("input.xlsm"))
          ...
          SignResult result = signature.Sign("output.xlsm", options);
