...
############################# Head ############################
head_title: "Add TIFF Image Watermark to XLT Viewer in C# .NET"
head_description: "C# .NET API to add TIFF image watermark into Excel spreadsheet (XLT) formats and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add TIFF Image Watermark to XLT Viewer"
description: "Insert TIFF or any other image watermark into Excel spreadsheet (XLT) formats quite easily and accurately using GroupDocs.Total suite of documents automation APIs for C# .NET applications."
