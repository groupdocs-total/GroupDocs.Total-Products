...
############################# Head ############################
head_title: "Add JPE Image Watermark to DOTM Viewer in C# .NET"
head_description: "C# .NET API to add JPE image watermark into Word processing documents (DOTM) and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add JPE Image Watermark to DOTM Viewer"
description: "Insert JPE or any other image watermark into Word processing (DOTM) file format quite easily and accurately using GroupDocs.Total suite of documents automation APIs for C# .NET applications."
...
steps:
    enable: true
    title_left: "Adding image watermark to DOTM file in .NET"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/net/) makes it easy for developers to integrate JPE image watermark into Word (DOTM) documents using a few lines of C# .NET code.
    ...
    code: |
        ```cs
        // Add watermark to DOTM file using GroupDocs.Watermark API
        // Instantiate Watermarker with input DOTM document
