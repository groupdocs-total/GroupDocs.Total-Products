...
############################# Head ############################
head_title: "Add WebP Image Watermark to Text File in C# .NET"
head_description: "C# .NET API to add WebP image watermark into text document file and 90+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add WebP Image Watermark to Text File in .NET"
description: "Insert WebP or any image watermark into text document file quite easily and accurately using GroupDocs.Total suite of documents automation APIs for C# .NET applications."
...
steps:
    enable: true
    title_left: "Adding image watermark to TXT file in .NET"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/net/) makes it easy for developers to integrate WebP image watermark into TXT document file using a few lines of C# .NET code.
    ...
    code: |
        ...
        // Instantiate viewer with output document
        using (Viewer viewer = new GroupDocs.Viewer.Viewer("output.txt"))
          {
            // Set options to view document as HTML
