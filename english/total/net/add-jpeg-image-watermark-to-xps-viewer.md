...
############################# Head ############################
head_title: "Add JPEG Image Watermark to XPS Viewer in C# .NET"
head_description: "C# .NET API to add JPEG image watermark into an XML Paper Specification file (XPS) and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add JPEG Image Watermark to XPS Viewer"
description: "Insert JPEG or any other image watermark into an XML Paper Specification file (XPS) quite easily and accurately using GroupDocs.Total suite of documents automation APIs for C# .NET applications."
...
steps:
    ...
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/net/) makes it easy for developers to integrate JPEG image watermark into an XML Paper Specification file (XPS) using a few lines of C# .NET code.
