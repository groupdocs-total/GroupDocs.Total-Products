...
############################# Head ############################
head_title: "Add Barcode Signatures to XLSB Viewer in C# .NET"
head_description: "Add 60+ digital barcode signatures to Excel spreadsheet (XLSB) formats and 100+ other file formats. View the signed file in HTML using GroupDocs.Total for .NET APIs."

############################# Header ############################
title: "Add Barcode Signatures to XLSB Viewer"
description: "Digitally sign and secure Excel spreadsheet (XLSB) formats by adding 60+ barcode signature types in your C#, .NET or VB.NET applications using GroupDocs.Total APIs."
...
steps:
    enable: true
    title_left: "Adding barcode signatures to XLSB file in .NET"
    content_left: |
    ...
    code: |
        ```cs
        // Add barcode signature to XLSB file using GroupDocs.Signature API
