...
############################# Head ############################
head_title: "Add JPG Image Watermark to RTF in C# .NET"
head_description: "C# .NET API to add JPG image watermark into Rich Text Format (RTF) documents and 90+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add JPG Image Watermark to RTF in .NET"
description: "Insert JPG or any image watermark into Rich Text Format (RTF) files quite easily and accurately using GroupDocs.Total suite of documents automation APIs for C# .NET applications."
...
steps:
    ...
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/net/) makes it easy for developers to integrate JPG image watermark into Rich Text Format (RTF) documents using a few lines of C# .NET code.
