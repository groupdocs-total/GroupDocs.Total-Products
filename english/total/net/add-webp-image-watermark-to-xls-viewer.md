...
############################# Head ############################
head_title: "Add WebP Image Watermark to XLS File in C# .NET"
head_description: "C# .NET API to add WebP image watermark into Excel spreadsheet (XLS) and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add WebP Image Watermark to XLS in .NET"
description: "Insert WebP or any other image watermark into Excel spreadsheet (XLS) formats quite easily and accurately using GroupDocs.Total suite of documents automation APIs for C# .NET applications."
...
steps:
    enable: true
    title_left: "Adding image watermark to XLS file in .NET"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/net/) makes it easy for developers to integrate WebP image watermark into Excel (XLS) worksheets using a few lines of C# .NET code.
    ...
    code: |
        ...
        // Instantiate viewer with output document
        using (Viewer viewer = new GroupDocs.Viewer.Viewer("output.xls"))
          {
            // Set options to view document as HTML
