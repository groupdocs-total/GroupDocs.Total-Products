...
############################# Head ############################
head_title: "Add PNG Image Watermark to Word DOC in C# .NET"
head_description: "C# .NET API to add PNG image watermark into Word processing documents (DOC) and 90+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add PNG Image Watermark to DOC in .NET"
description: "Insert PNG or any image watermark into Word processing (DOC) file format quite easily and accurately using GroupDocs.Total suite of documents automation APIs for C# .NET applications."
...
steps:
    ...
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/net/) makes it easy for developers to integrate PNG image watermark into Word (DOC) documents using a few lines of C# .NET code.
