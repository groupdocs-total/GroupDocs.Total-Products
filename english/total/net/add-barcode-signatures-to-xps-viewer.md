...
############################# Head ############################
head_title: "Add Barcode Signatures to XPS Viewer in C# .NET"
head_description: "Add 60+ digital barcode signatures to an XML Paper Specification file (XPS) and 100+ other file formats. View the signed file in HTML using GroupDocs.Total for .NET APIs."

############################# Header ############################
title: "Add Barcode Signatures to XPS Viewer"
description: "Digitally sign and secure an XML Paper Specification file (XPS) by adding 60+ barcode signature types in your C#, .NET or VB.NET applications using GroupDocs.Total APIs."
...
steps:
    enable: true
    title_left: "Adding barcode signatures to XPS file in .NET"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/net/) makes it easy for developers to digitally sign an XML Paper Specification file (XPS) with barcode signatures using a few lines of C# .NET code.
    ...
    code: |
        ```cs
        // Add barcode signature to XPS file using GroupDocs.Signature API
        ...
        using (Signature signature = new Signature("input.xps"))
          ...
          SignResult result = signature.Sign("output.xps", options);
