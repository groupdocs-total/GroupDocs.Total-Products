...
############################# Head ############################
head_title: "Add Metadata Signatures to Presentation Viewer in C# .NET"
head_description: "Add digital metadata signatures to PowerPoint presentations in C# .NET applications. View the signed file in HTML, Image or PDF viewer using GroupDocs.Total for .NET APIs."

############################# Header ############################
title: "Add Metadata Signatures to Presentation Viewer"
description: "Add digital metadata signatures to PowerPoint presentation file formats. View the signed file in HTML, Image or PDF viewer using GroupDocs.Total APIs for .NET (C#, ASP.NET, VB.NET, .NET Core) applications."
...
steps:
    enable: true
    title_left: "Adding metadata signatures to presentations in .NET"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/net/) makes it easy for developers to digitally sign PowerPoint presentation file formats with metadata signatures using a few lines of C# .NET code.
    ...
    code: |
        ...
        // Instantiate Signature with input PPTX file
