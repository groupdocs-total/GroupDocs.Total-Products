...
############################# Head ############################
head_title: "Add Metadata Signatures to DOTM Viewer in C# .NET"
head_description: "Add digital metadata signatures to Word processing documents (DOTM) in C# .NET applications. View the signed file in HTML, Image or PDF viewer using GroupDocs.Total for .NET APIs."

############################# Header ############################
title: "Add Metadata Signatures to .NET DOTM Viewer"
description: "Add digital metadata signatures to Word processing (DOTM) file format. View the signed file in HTML, Image or PDF viewer using GroupDocs.Total APIs for .NET (C#, ASP.NET, VB.NET, .NET Core) applications."
...
steps:
    enable: true
    title_left: "Adding metadata signatures to DOTM in .NET"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/net/) makes it easy for developers to digitally sign Word (DOTM) documents with metadata signatures using a few lines of C# .NET code.
