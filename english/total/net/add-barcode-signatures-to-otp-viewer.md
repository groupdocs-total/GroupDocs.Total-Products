...
############################# Head ############################
head_title: "Add Barcode Signatures to OTP Viewer in C# .NET"
head_description: "Add 60+ digital barcode signatures to an OpenDocument presentation template file (OTP) and 100+ other file formats. View the signed file in HTML using GroupDocs.Total for .NET APIs."

############################# Header ############################
title: "Add Barcode Signatures to OTP Viewer"
description: "Digitally sign and secure an OpenDocument presentation template file (OTP) by adding 60+ barcode signature types in your C#, .NET or VB.NET applications using GroupDocs.Total APIs."
...
steps:
    enable: true
    title_left: "Adding barcode signatures to OTP file in .NET"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/net/) makes it easy for developers to digitally sign an OpenDocument presentation template file (OTP) with barcode signatures using a few lines of C# .NET code.
    ...
    code: |
        ```cs
        // Add barcode signature to OTP file using GroupDocs.Signature API
        ...
        using (Signature signature = new Signature("input.otp"))
          ...
          SignResult result = signature.Sign("output.otp", options);
