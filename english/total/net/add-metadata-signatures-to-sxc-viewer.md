...
############################# Head ############################
head_title: "Add Metadata Signatures to SXC Viewer in C# .NET"
head_description: "Add digital metadata signatures to Excel spreadsheet (SXC) formats in C# .NET applications. View the signed file in HTML, Image or PDF viewer using GroupDocs.Total for .NET APIs."

############################# Header ############################
title: "Add Metadata Signatures to .NET SXC Viewer"
description: "Add digital metadata signatures to Excel spreadsheet (SXC) formats. View the signed file in HTML, Image or PDF viewer using GroupDocs.Total APIs for .NET (C#, ASP.NET, VB.NET, .NET Core) applications."
...
steps:
    enable: true
    title_left: "Adding metadata signatures to SXC in .NET"
    content_left: |
