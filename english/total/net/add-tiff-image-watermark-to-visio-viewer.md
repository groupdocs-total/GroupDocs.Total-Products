...
############################# Head ############################
head_title: "Add TIFF Image Watermark to Visio Viewer in C# .NET"
head_description: "C# .NET API to add TIFF image watermark into Microsoft Visio Drawing files and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add TIFF Image Watermark to Visio Viewer"
description: "Insert TIFF or any other image watermark into Microsoft Visio Drawing files quite easily and accurately using GroupDocs.Total suite of documents automation APIs for C# .NET applications."
...
steps:
    ...
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/net/) makes it easy for developers to integrate TIFF image watermark into Microsoft Visio Drawing documents using a few lines of C# .NET code.
