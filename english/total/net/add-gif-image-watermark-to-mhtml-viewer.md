...
############################# Head ############################
head_title: "Add GIF Image Watermark to MHTML Viewer in C# .NET"
head_description: "C# .NET API to add GIF image watermark into a web page archive format (MHTML) and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add GIF Image Watermark to MHTML Viewer"
description: "Insert GIF or any other image watermark into a web page archive format (MHTML) quite easily and accurately using GroupDocs.Total suite of documents automation APIs for C# .NET applications."
...
steps:
    ...
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/net/) makes it easy for developers to integrate GIF image watermark into a web page archive format (MHTML) using a few lines of C# .NET code.
