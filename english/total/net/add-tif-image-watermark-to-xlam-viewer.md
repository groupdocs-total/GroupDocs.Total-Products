...
############################# Head ############################
head_title: "Add TIF Image Watermark to XLAM Viewer in C# .NET"
head_description: "C# .NET API to add TIF image watermark into Excel spreadsheet (XLAM) formats and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add TIF Image Watermark to XLAM Viewer"
description: "Insert TIF or any other image watermark into Excel spreadsheet (XLAM) formats quite easily and accurately using GroupDocs.Total suite of documents automation APIs for C# .NET applications."
