...
############################# Head ############################
head_title: "Add Metadata Signatures to TIF Viewer in C# .NET"
head_description: "Add digital metadata signatures to TIF image file format in C# .NET applications. View the signed file in HTML, Image or PDF viewer using GroupDocs.Total for .NET APIs."

############################# Header ############################
title: "Add Metadata Signatures to .NET TIF Viewer"
description: "Add digital metadata signatures to TIF image file format. View the signed file in HTML, Image or PDF viewer using GroupDocs.Total APIs for .NET (C#, ASP.NET, VB.NET, .NET Core) applications."
...
steps:
    ...
    code: |
        ...
        // Instantiate Signature with input TIF file
