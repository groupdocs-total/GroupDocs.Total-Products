...
############################# Head ############################
head_title: "Add JPEG Image Watermark to POTM Viewer in C# .NET"
head_description: "C# .NET API to add JPEG image watermark into PowerPoint template (POTM) and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add JPEG Image Watermark to POTM Viewer"
description: "Insert JPEG or any other image watermark into PowerPoint template (POTM) files quite easily and accurately using GroupDocs.Total suite of documents automation APIs for C# .NET applications."
