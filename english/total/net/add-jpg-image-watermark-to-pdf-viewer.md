...
############################# Head ############################
head_title: "Add JPG Image Watermark to PDF Viewer in C# .NET"
head_description: "C# .NET API to add JPG image watermark into PDF Viewer documents and 170+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add JPG Image Watermark to PDF in .NET"
description: "Insert JPG or any image watermark into PDF Viewer documents quite easily and accurately using GroupDocs.Total suite of documents automation APIs for C# .NET applications."
...
steps:
    ...
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/net/) makes it easy for developers to integrate JPG image watermark into PDF Viewer applications using a few lines of C# .NET code.
