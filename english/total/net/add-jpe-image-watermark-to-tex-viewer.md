...
############################# Head ############################
head_title: "Add JPE Image Watermark to TEX Viewer in C# .NET"
head_description: "C# .NET API to add JPE image watermark into a source document prepared by LaTeX (TEX) and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add JPE Image Watermark to TEX Viewer"
description: "Insert JPE or any other image watermark into a source document prepared by LaTeX (TEX) quite easily and accurately using GroupDocs.Total suite of documents automation APIs for C# .NET applications."
...
steps:
    enable: true
    title_left: "Adding image watermark to TEX file in .NET"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/net/) makes it easy for developers to integrate JPE image watermark into a source document prepared by LaTeX (TEX) using a few lines of C# .NET code.

        *   Instantiate Watermarker with input TEX file
    ...
    code: |
        ```cs
        // Add watermark to TEX file using GroupDocs.Watermark API
