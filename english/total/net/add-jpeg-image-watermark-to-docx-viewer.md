...
############################# Head ############################
head_title: "Add JPEG Image Watermark to Word DOCX in C# .NET"
head_description: "C# .NET API to add JPEG image watermark into Word processing documents (DOCX) and 90+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add JPEG Image Watermark to DOCX in .NET"
description: "Insert JPEG or any image watermark into Word processing document formats quite easily and accurately using GroupDocs.Total suite of documents automation APIs for C# .NET applications."
...
steps:
    ...
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/net/) makes it easy for developers to integrate JPEG image watermark into Word documents using a few lines of C# .NET code.
    ...
    code: |
        ...
        using (Viewer viewer = new Viewer("sample.docx"))
        {
          ...
          using (ImageWatermark watermark = new ImageWatermark("logo.jpeg"))
          {
