...
############################# Head ############################
head_title: "Add JPE Image Watermark to EML Viewer in C# .NET"
head_description: "C# .NET API to add JPE image watermark into an email message (EML) and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add JPE Image Watermark to EML Viewer"
description: "Insert JPE or any other image watermark into email message files (EML) quite easily and accurately using GroupDocs.Total suite of documents automation APIs for C# .NET applications."
...
steps:
    enable: true
    title_left: "Adding image watermark to EML file in .NET"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/net/) makes it easy for developers to integrate JPE image watermark into email message documents (EML) using a few lines of C# .NET code.

        *   Instantiate Watermarker with input EML file
    ...
    code: |
        ```cs
        // Add watermark to EML file using GroupDocs.Watermark API
