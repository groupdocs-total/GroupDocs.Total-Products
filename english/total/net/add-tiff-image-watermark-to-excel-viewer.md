...
############################# Head ############################
head_title: "Add TIFF Image Watermark to Excel File in C# .NET"
head_description: "C# .NET API to add TIFF image watermark into Excel spreadsheets and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add TIFF Image Watermark to Excel in .NET"
description: "Insert TIFF or any other image watermark into Excel spreadsheet formats quite easily and accurately using GroupDocs.Total suite of documents automation APIs for C# .NET applications."
