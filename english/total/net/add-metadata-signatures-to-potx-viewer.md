...
############################# Head ############################
head_title: "Add Metadata Signatures to POTX Viewer in C# .NET"
head_description: "Add digital metadata signatures to PowerPoint template presentations (POTX) in C# .NET applications. View the signed file in HTML, Image or PDF viewer using GroupDocs.Total for .NET APIs."

############################# Header ############################
title: "Add Metadata Signatures to .NET POTX Viewer"
description: "Add digital metadata signatures to PowerPoint template presentation (POTX) files. View the signed file in HTML, Image or PDF viewer using GroupDocs.Total APIs for .NET (C#, ASP.NET, VB.NET, .NET Core) applications."
...
steps:
    enable: true
    title_left: "Adding metadata signatures to POTX in .NET"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/net/) makes it easy for developers to digitally sign PowerPoint template presentations (POTX) with metadata signatures using a few lines of C# .NET code.
    ...
    code: |
        ...
        // Instantiate Signature with input POTX file
