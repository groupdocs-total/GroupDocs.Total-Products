...
############################# Head ############################
head_title: "Add JP2 Image Watermark to Word DOCX in C# .NET"
head_description: "C# .NET API to add JP2 image watermark into Word processing documents (DOCX) and 90+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add JP2 Image Watermark to DOCX in .NET"
description: "Insert JP2 or any image watermark into Word processing document formats quite easily and accurately using GroupDocs.Total suite of documents automation APIs for C# .NET applications."
...
steps:
    ...
    code: |
        ...
        using (Viewer viewer = new Viewer("sample.docx"))
        {
          ...
          using (ImageWatermark watermark = new ImageWatermark("logo.jp2"))
          {
