...
############################# Head ############################
head_title: "Add Barcode Signatures to Presentation Viewer in C# .NET"
head_description: "Add 60+ digital barcode signatures to PowerPoint presentations and 100+ other file formats. View the signed file in HTML using GroupDocs.Total for .NET APIs."

############################# Header ############################
title: "Add Barcode Signatures to Presentation Viewer"
description: "Digitally sign and secure PowerPoint presentation file formats by adding 60+ barcode signature types in your C#, .NET or VB.NET applications using GroupDocs.Total APIs."
...
steps:
    enable: true
    title_left: "Adding barcode signatures to presentations in .NET"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/net/) makes it easy for developers to digitally sign PowerPoint presentation file formats with barcode signatures using a few lines of C# .NET code.
    ...
    code: |
        ```cs
        // Add barcode signature to PPTX file using GroupDocs.Signature API
