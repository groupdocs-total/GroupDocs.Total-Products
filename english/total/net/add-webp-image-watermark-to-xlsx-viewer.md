...
############################# Head ############################
head_title: "Add WebP Image Watermark to XLSX File in C# .NET"
head_description: "C# .NET API to add WebP image watermark into Excel spreadsheet (XLSX) and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add WebP Image Watermark to XLSX in .NET"
description: "Insert WebP or any other image watermark into Excel spreadsheet (XLSX) formats quite easily and accurately using GroupDocs.Total suite of documents automation APIs for C# .NET applications."
...
steps:
    enable: true
    title_left: "Adding image watermark to XLSX file in .NET"
    content_left: |
    ...
    code: |
        ...
        // Instantiate viewer with output document
        using (Viewer viewer = new GroupDocs.Viewer.Viewer("output.xlsx"))
          {
            // Set options to view document as HTML
