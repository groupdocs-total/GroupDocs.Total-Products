...
############################# Head ############################
head_title: "Add Barcode Signatures to MPX Viewer in C# .NET"
head_description: "Add 60+ digital barcode signatures to Microsoft Project Exchange (MPX) and 100+ other file formats. View the signed file in HTML using GroupDocs.Total for .NET APIs."

############################# Header ############################
title: "Add Barcode Signatures to MPX Viewer"
description: "Digitally sign and secure Microsoft Project Exchange files (MPX) by adding 60+ barcode signature types in your C#, .NET or VB.NET applications using GroupDocs.Total APIs."
...
steps:
    enable: true
    title_left: "Adding barcode signatures to MPX file in .NET"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/net/) makes it easy for developers to digitally sign Microsoft Project Exchange documents (MPX) with barcode signatures using a few lines of C# .NET code.
    ...
    code: |
        ...
        using (Signature signature = new Signature("input.mpx"))
          ...
          SignResult result = signature.Sign("output.mpx", options);
