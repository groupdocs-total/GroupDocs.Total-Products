...
############################# Head ############################
head_title: "Add Barcode Signatures to XLAM Viewer in C# .NET"
head_description: "Add 60+ digital barcode signatures to Excel spreadsheet (XLAM) formats and 100+ other file formats. View the signed file in HTML using GroupDocs.Total for .NET APIs."

############################# Header ############################
title: "Add Barcode Signatures to XLAM Viewer"
description: "Digitally sign and secure Excel spreadsheet (XLAM) formats by adding 60+ barcode signature types in your C#, .NET or VB.NET applications using GroupDocs.Total APIs."
...
steps:
    enable: true
    title_left: "Adding barcode signatures to XLAM file in .NET"
    content_left: |
