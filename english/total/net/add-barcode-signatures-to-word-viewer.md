...
############################# Head ############################
head_title: "Add Barcode Signatures to Word Viewer in C# .NET"
head_description: "Add 60+ digital barcode signatures to Word processing documents and 100+ other file formats. View the signed file in HTML using GroupDocs.Total for .NET APIs."

############################# Header ############################
title: "Add Barcode Signatures to Word Viewer"
...
steps:
    enable: true
    title_left: "Adding barcode signatures to Word file in .NET"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/net/) makes it easy for developers to digitally sign Word documents with barcode signatures using a few lines of C# .NET code.
