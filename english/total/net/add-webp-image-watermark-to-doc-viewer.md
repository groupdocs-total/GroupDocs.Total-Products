...
############################# Head ############################
head_title: "Add WebP Image Watermark to Word DOC in C# .NET"
head_description: "C# .NET API to add WebP image watermark into Word processing documents (DOC) and 90+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add WebP Image Watermark to DOC in .NET"
description: "Insert WebP or any image watermark into Word processing (DOC) file format quite easily and accurately using GroupDocs.Total suite of documents automation APIs for C# .NET applications."
...
steps:
    enable: true
    title_left: "Adding image watermark to DOC file in .NET"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/net/) makes it easy for developers to integrate WebP image watermark into Word (DOC) documents using a few lines of C# .NET code.
    ...
    code: |
        ...
        // Instantiate viewer with output document
        using (Viewer viewer = new GroupDocs.Viewer.Viewer("output.doc"))
          {
            // Set options to view document as HTML
