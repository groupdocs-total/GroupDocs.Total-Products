...
############################# Head ############################
head_title: "Add TIF Image Watermark to VSDX Viewer in C# .NET"
head_description: "C# .NET API to add TIF image watermark into Microsoft Visio Drawing files (VSDX) and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add TIF Image Watermark to VSDX Viewer"
description: "Insert TIF or any other image watermark into Microsoft Visio Drawing files (VSDX) quite easily and accurately using GroupDocs.Total suite of documents automation APIs for C# .NET applications."
...
steps:
    ...
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/net/) makes it easy for developers to integrate TIF image watermark into Microsoft Visio Drawing (VSDX) documents using a few lines of C# .NET code.
