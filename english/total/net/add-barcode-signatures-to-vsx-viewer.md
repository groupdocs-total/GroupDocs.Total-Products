...
############################# Head ############################
head_title: "Add Barcode Signatures to VSX Viewer in C# .NET"
head_description: "Add 60+ digital barcode signatures to Microsoft Visio Stencil XML (VSX) and 100+ other file formats. View the signed file in HTML using GroupDocs.Total for .NET APIs."

############################# Header ############################
title: "Add Barcode Signatures to VSX Viewer"
description: "Digitally sign and secure Microsoft Visio Stencil XML (VSX) files by adding 60+ barcode signature types in your C#, .NET or VB.NET applications using GroupDocs.Total APIs."
...
steps:
    enable: true
    title_left: "Adding barcode signatures to VSX file in .NET"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/net/) makes it easy for developers to digitally sign Microsoft Visio Stencil XML (VSX) documents with barcode signatures using a few lines of C# .NET code.
    ...
    code: |
        ...
        using (Signature signature = new Signature("input.vsx"))
          ...
          SignResult result = signature.Sign("output.vsx", options);
