...
head_description: "C# .NET API to add image watermark into Word processing documents and 90+ file formats using GroupDocs.Total suite of documents automation APIs for C# .NET applications."

############################# Header ############################
title: "Add PNG Image Watermark to DOCX in .NET"
description: "Insert any image watermark into Word processing document formats quite easily and accurately using GroupDocs.Total suite of documents automation APIs for C# .NET applications."
...
steps:
    enable: true
    title_left: "Steps to add image watermarks to Word file in .NET"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/net/) makes it easy for developers to integrate image watermark into Word documents using a few lines of C# .NET code.
