...
############################# Head ############################
head_title: "Add Barcode Signatures to VSDM Viewer in C# .NET"
head_description: "Add 60+ digital barcode signatures to Microsoft Visio macro-enabled drawing (VSDM) and 100+ other file formats. View the signed file in HTML using GroupDocs.Total for .NET APIs."

############################# Header ############################
title: "Add Barcode Signatures to VSDM Viewer"
description: "Digitally sign and secure Microsoft Visio macro-enabled drawing files (VSDM) by adding 60+ barcode signature types in your C#, .NET or VB.NET applications using GroupDocs.Total APIs."
...
steps:
    enable: true
    title_left: "Adding barcode signatures to VSDM file in .NET"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/net/) makes it easy for developers to digitally sign Microsoft Visio macro-enabled drawing documents (VSDM) with barcode signatures using a few lines of C# .NET code.

        *   Instantiate Signature with input document
        *   Create barcode option with predefined barcode text
        *   Setup barcode encoding type
        *   Set the barcode signature position
        *   Add signature and genearte output document
    ...
    code: |
        ```cs
        // Add barcode signature to VSDM file using GroupDocs.Signature API
        ...
        using (Signature signature = new Signature("input.vsdm"))
          ...
          SignResult result = signature.Sign("output.vsdm", options);
