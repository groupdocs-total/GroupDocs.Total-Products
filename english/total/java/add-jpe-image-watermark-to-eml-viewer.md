...
############################# Head ############################
head_title: "Add JPE Image Watermark to EML Viewer in Java"
head_description: "Java API to add JPE image watermark into an email message (EML) and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add JPE Image Watermark to EML Viewer"
description: "Add JPE or other types of image watermarks into email message files (EML) on any position with adjustable size and orientation using GroupDocs.Total suite of documents automation APIs for java applications."
...
steps:
    enable: true
    title_left: "Adding image watermark to EML file in Java"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/java/) makes it easy for developers to integrate JPE image watermark into email message documents (EML) using a few lines of Java code.
    ...
    code: |
        ```cs
        // Add watermark to Email message (EML) file using GroupDocs.Watermark API
        // Instantiate FileInputStream Object with input file
