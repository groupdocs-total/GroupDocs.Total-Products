...
############################# Head ############################
head_title: "Add Metadata Signatures to WebP Viewer in Java"
head_description: "Add digital metadata signatures to WebP image file format in Java applications. View the signed file in HTML, Image or PDF viewer using GroupDocs.Total for Java APIs."

############################# Header ############################
title: "Add Metadata Signatures to Java WebP Viewer"
description: "Add digital metadata signatures to WebP image file format. View the signed file in HTML, Image or PDF viewer using GroupDocs.Total APIs for Java applications."
