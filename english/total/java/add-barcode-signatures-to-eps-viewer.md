...
############################# Head ############################
head_title: "Add Barcode Signatures to EPS Viewer in Java"
head_description: "Add 60+ digital barcode signatures to an encapsulated PostScript (EPS) file and 100+ other file formats. View the signed file in HTML using GroupDocs.Total for Java APIs."

############################# Header ############################
title: "Add Barcode Signatures to EPS Viewer"
description: "Digitally sign and secure an encapsulated PostScript (EPS) file by adding 60+ barcode signature types in your Java applications using GroupDocs.Total APIs."
...
steps:
    enable: true
    title_left: "Adding barcode signatures to EPS in Java"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/java/) makes it easy for developers to digitally sign an encapsulated PostScript (EPS) file with barcode signatures using a few lines of Java code.
    ...
    code: |
        ...
        Signature signature = new Signature("input.eps");
        try 
          {
            ...
            // sign the document
            signature.sign("output.eps", signOptions);
