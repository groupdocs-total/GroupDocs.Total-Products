...
############################# Head ############################
head_title: "Add TIFF Image Watermark to XLT Viewer in Java"
head_description: "Java API to add TIFF image watermark into Excel spreadsheet (XLT) formats and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add TIFF Image Watermark to XLT Viewer"
description: "Add TIFF or other types of image watermarks into Excel spreadsheet (XLT) formats on any position with adjustable size and orientation using GroupDocs.Total suite of documents automation APIs for java applications."
