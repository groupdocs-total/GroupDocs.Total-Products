...
############################# Head ############################
head_title: "Add Metadata Signatures to XLTM Viewer in Java"
head_description: "Add digital metadata signatures to Excel spreadsheet (XLTM) formats in Java applications. View the signed file in HTML, Image or PDF viewer using GroupDocs.Total for Java APIs."

############################# Header ############################
title: "Add Metadata Signatures to Java XLTM Viewer"
description: "Add digital metadata signatures to Excel spreadsheet (XLTM) formats. View the signed file in HTML, Image or PDF viewer using GroupDocs.Total APIs for Java applications."
...
steps:
    enable: true
    title_left: "Adding metadata signatures to XLTM in Java"
    content_left: |
