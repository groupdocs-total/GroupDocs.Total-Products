...
############################# Head ############################
head_title: "Add WebP Image Watermark to EMLX Viewer in Java"
head_description: "Java API to add WebP image watermark into an Apple Mail Email (EMLX) and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add WebP Image Watermark to EMLX Viewer"
description: "Add WebP or other types of image watermarks into Apple Mail Email files (EMLX) on any position with adjustable size and orientation using GroupDocs.Total suite of documents automation APIs for java applications."
...
steps:
    ...
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/java/) makes it easy for developers to integrate WebP image watermark into Apple Mail Email documents (EMLX) using a few lines of Java code.
