...
############################# Head ############################
head_title: "Add Metadata Signatures to TIFF Viewer in Java"
head_description: "Add digital metadata signatures to TIFF image file format in Java applications. View the signed file in HTML, Image or PDF viewer using GroupDocs.Total for Java APIs."

############################# Header ############################
title: "Add Metadata Signatures to Java TIFF Viewer"
description: "Add digital metadata signatures to TIFF image file format. View the signed file in HTML, Image or PDF viewer using GroupDocs.Total APIs for Java applications."
...
steps:
    enable: true
    title_left: "Adding metadata signatures to Images in Java"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/java/) makes it easy for developers to digitally sign images with metadata signatures using a few lines of Java code.
        ...
        *   Instantiate one or more <mark>**ImageMetadataSignature**</mark> objects and add them into <mark>**MetadataSignOptions**</mark> to metadata signatures collection (<mark>**getSignatures**</mark>) via <mark>**Add**</mark> or <mark>**AddRange**</mark> method.
