...
############################# Head ############################
head_title: "Add Barcode Signatures to EMLX Viewer in Java"
head_description: "Add 60+ digital barcode signatures to an Apple Mail Email (EMLX) and 100+ other file formats. View the signed file in HTML using GroupDocs.Total for Java APIs."

############################# Header ############################
title: "Add Barcode Signatures to EMLX Viewer"
description: "Digitally sign and secure Apple Mail Email files (EMLX) by adding 60+ barcode signature types in your Java applications using GroupDocs.Total APIs."
...
steps:
    enable: true
    title_left: "Adding barcode signatures to EMLX in Java"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/java/) makes it easy for developers to digitally sign Apple Mail Email documents (EMLX) with barcode signatures using a few lines of Java code.
    ...
    code: |
        ...
        Signature signature = new Signature("input.emlx");
        try 
          {
            ...
            // sign the document
            signature.sign("output.emlx", signOptions);
