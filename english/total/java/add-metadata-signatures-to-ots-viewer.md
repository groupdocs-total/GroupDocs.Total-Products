...
############################# Head ############################
head_title: "Add Metadata Signatures to OTS Viewer in Java"
head_description: "Add digital metadata signatures to an OpenDocument Spreadsheet template file (OTS) in Java applications. View the signed file in HTML, Image or PDF viewer using GroupDocs.Total for Java APIs."

############################# Header ############################
title: "Add Metadata Signatures to Java OTS Viewer"
description: "Add digital metadata signatures to an OpenDocument Spreadsheet template file (OTS). View the signed file in HTML, Image or PDF viewer using GroupDocs.Total APIs for Java applications."
...
steps:
    enable: true
    title_left: "Adding metadata signatures to OTS in Java"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/java/) makes it easy for developers to digitally sign an OpenDocument Spreadsheet template file (OTS) with metadata signatures using a few lines of Java code.
    ...
    code: |
        ...
        // Instantiate Signature with input OTS file
