...
############################# Head ############################
head_title: "Add Metadata Signatures to POT Viewer in Java"
head_description: "Add digital metadata signatures to PowerPoint template (POT) in Java applications. View the signed file in HTML, Image or PDF viewer using GroupDocs.Total for Java APIs."

############################# Header ############################
title: "Add Metadata Signatures to Java POT Viewer"
description: "Add digital metadata signatures to PowerPoint template (POT) files. View the signed file in HTML, Image or PDF viewer using GroupDocs.Total APIs for Java applications."
...
steps:
    enable: true
    title_left: "Adding metadata signatures to POT in Java"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/java/) makes it easy for developers to digitally sign PowerPoint template (POT) files with metadata signatures using a few lines of Java code.
