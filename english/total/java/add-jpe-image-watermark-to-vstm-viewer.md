...
############################# Head ############################
head_title: "Add JPE Image Watermark to VSTM Viewer in Java"
head_description: "Java API to add JPE image watermark into macro-enabled drawing template created by Visio (VSTM) and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add JPE Image Watermark to VSTM Viewer"
description: "Add JPE or other types of image watermarks into macro-enabled drawing template files created by Visio (VSTM) on any position with adjustable size and orientation using GroupDocs.Total suite of documents automation APIs for java applications."
...
steps:
    enable: true
    title_left: "Adding image watermark to VSTM file in Java"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/java/) makes it easy for developers to integrate JPE image watermark into macro-enabled drawing template documents created by Visio (VSTM) using a few lines of Java code.

        *   Instantiate Watermarker with input VSTM file
        *   Use JPE watermark image path as constructor parameter of ImageWatermark class
    ...
    code: |
        ```cs
        // Add watermark to VSTM file using GroupDocs.Watermark API
        // Instantiate FileInputStream Object with
FileInputStream stream = new FileInputStream("input. input VSTM document
        using (Watermarker watermarker = new Watermarker("input.vstm"))
          {
            // Use JPE watermark image path as constructor parameter of ImageWatermark class
            using (ImageWatermark watermark = new ImageWatermark("watermark.jpe"))
            {
