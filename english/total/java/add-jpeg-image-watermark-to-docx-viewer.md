...
############################# Head ############################
head_title: "Add JPEG Image Watermark to Word DOCX Viewer in Java"
head_description: "Java API to add JPEG image watermark into Word processing documents (DOCX) and 90+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add JPEG Image Watermark to DOCX Viewer"
...
steps:
    ...
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/java/) makes it easy for developers to integrate JPEG image watermark into Word (DOCX) documents using a few lines of Java code.
