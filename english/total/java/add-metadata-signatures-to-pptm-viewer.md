...
############################# Head ############################
head_title: "Add Metadata Signatures to PPTM Viewer in Java"
head_description: "Add digital metadata signatures to PowerPoint presentation (PPTM) in Java applications. View the signed file in HTML, Image or PDF viewer using GroupDocs.Total for Java APIs."

############################# Header ############################
title: "Add Metadata Signatures to Java PPTM Viewer"
description: "Add digital metadata signatures to PowerPoint PowerPoint presentation (PPTM) files. View the signed file in HTML, Image or PDF viewer using GroupDocs.Total APIs for Java applications."
...
steps:
    enable: true
    title_left: "Adding metadata signatures to PPTM in Java"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/java/) makes it easy for developers to digitally sign PowerPoint presentation (PPTM) files with metadata signatures using a few lines of Java code.
