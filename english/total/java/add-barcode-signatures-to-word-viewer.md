...
############################# Head ############################
head_title: "Add Barcode Signatures to Word Viewer in Java"
head_description: "Add 60+ digital barcode signatures to Word processing documents and 100+ other file formats. View the signed file in HTML using GroupDocs.Total for Java APIs."
...
steps:
    enable: true
    title_left: "Adding barcode signatures to Word in Java"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/java/) makes it easy for developers to digitally sign Word documents with barcode signatures using a few lines of Java code.
