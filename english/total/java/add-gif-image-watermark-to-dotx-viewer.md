...
############################# Head ############################
head_title: "Add GIF Image Watermark to Word DOTX Viewer in Java"
head_description: "Java API to add GIF image watermark into Word processing documents (DOTX) and 90+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add GIF Image Watermark to DOTX Viewer"
description: "Add GIF or any image watermark into Word processing document formats on any position with adjustable size and orientation using GroupDocs.Total suite of documents automation APIs for java applications."
...
steps:
    ...
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/java/) makes it easy for developers to integrate GIF image watermark into Word (DOTX) documents using a few lines of Java code.
