...
############################# Head ############################
head_title: "Add GIF Image Watermark to OXPS Viewer in Java"
head_description: "Java API to add GIF image watermark into an Open XML Paper Specification file (OXPS) and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add GIF Image Watermark to OXPS Viewer"
description: "Add GIF or other types of image watermarks into an Open XML Paper Specification file (OXPS) on any position with adjustable size and orientation using GroupDocs.Total suite of documents automation APIs for java applications."
...
steps:
    ...
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/java/) makes it easy for developers to integrate GIF image watermark into an Open XML Paper Specification file (OXPS) using a few lines of Java code.
