...
############################# Head ############################
head_title: "Add JPE Image Watermark to DOCM Viewer in Java"
head_description: "Java API to add JPE image watermark into Word processing documents (DOCM) and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add JPE Image Watermark to DOCM Viewer"
description: "Add JPE or other types of image watermarks into Word processing (DOCM) file format on any position with adjustable size and orientation using GroupDocs.Total suite of documents automation APIs for java applications."
...
steps:
    enable: true
    title_left: "Adding image watermark to DOCM file in Java"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/java/) makes it easy for developers to integrate JPE image watermark into Word (DOCM) documents using a few lines of Java code.
    ...
    code: |
        ```cs
        // Add watermark to Word Processing (DOCM) file using GroupDocs.Watermark API
        // Instantiate FileInputStream Object with input file
