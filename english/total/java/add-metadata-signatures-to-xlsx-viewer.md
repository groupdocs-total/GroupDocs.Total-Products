...
############################# Head ############################
head_title: "Add Metadata Signatures to XLSX File in Java"
head_description: "Add digital metadata signatures to Excel spreadsheet (XLSX) in Java applications. View the signed file in HTML, Image or PDF viewer using GroupDocs.Total for Java APIs."

############################# Header ############################
title: "Add Metadata Signatures to Java XLSX File"
description: "Add digital metadata signatures to Excel spreadsheet (XLSX) formats. View the signed file in HTML, Image or PDF viewer using GroupDocs.Total APIs for Java applications."
...
steps:
    enable: true
    title_left: "Adding metadata signatures to XLSX in Java"
    content_left: |
    ...
    code: |
        ...
        // Instantiate Signature with input XLSX file
