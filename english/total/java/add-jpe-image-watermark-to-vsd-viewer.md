...
############################# Head ############################
head_title: "Add JPE Image Watermark to VSD Viewer in Java"
head_description: "Java API to add JPE image watermark into Microsoft Visio Drawing files (VSD) and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add JPE Image Watermark to VSD Viewer"
description: "Add JPE or other types of image watermarks into Microsoft Visio Drawing files (VSD) on any position with adjustable size and orientation using GroupDocs.Total suite of documents automation APIs for java applications."
...
steps:
    enable: true
    title_left: "Adding image watermark to VSD file in Java"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/java/) makes it easy for developers to integrate JPE image watermark into Microsoft Visio Drawing (VSD) documents using a few lines of Java code.
    ...
    code: |
        ```cs
        // Add watermark to VSD file using GroupDocs.Watermark API
        // Instantiate FileInputStream Object with
FileInputStream stream = new FileInputStream("input. input VSD document
