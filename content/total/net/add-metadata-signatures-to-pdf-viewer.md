...
############################# Head ############################
head_title: "Add Metadata Signatures to PDF Viewer in C# .NET"
head_description: "Add digital metadata signatures to PDF documents in C# .NET applications. View the signed file in HTML, Image or PDF viewer using GroupDocs.Total for .NET APIs.."

############################# Header ############################
title: "Add Metadata Signatures to .NET PDF Viewer"
description: "Add digital metadata signatures to PDF documents. View the signed file in HTML, Image or PDF viewer using GroupDocs.Total APIs for .NET (C#, ASP.NET, VB.NET, .NET Core) applications.."
...
steps:
    enable: true
    title_left: "Adding metadata signatures to PDF in .NET"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/net/) makes it easy for developers to digitally sign PDF Viewer applications with metadata signatures using a few lines of C# .NET code.
        ...
        *   Instantiate one or more <mark>**PdfMetadataSignature**</mark> objects and add them into <mark>**MetadataSignOptions**</mark> to metadata signatures collection (<mark>**Signatures**</mark>) via <mark>**Add**</mark> or <mark>**AddRange**</mark> method.
