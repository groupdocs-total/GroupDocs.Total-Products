...
############################# Head ############################
head_title: "Add JPE Image Watermark to XPS Viewer in C# .NET"
head_description: "C# .NET API to add JPE image watermark into an XML Paper Specification file (XPS) and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add JPE Image Watermark to XPS Viewer"
description: "Insert JPE or any other image watermark into an XML Paper Specification file (XPS) quite easily and accurately using GroupDocs.Total suite of documents automation APIs for C# .NET applications."
...
steps:
    enable: true
    title_left: "Adding image watermark to XPS file in .NET"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/net/) makes it easy for developers to integrate JPE image watermark into an XML Paper Specification file (XPS) using a few lines of C# .NET code.

        *   Instantiate Watermarker with input XPS file
    ...
    code: |
        ```cs
        // Add watermark to XPS file using GroupDocs.Watermark API
        // Instantiate Watermarker with input XPS document
        using (Watermarker watermarker = new Watermarker("input.xps"))
          {
            // Use JPE watermark image path as constructor parameter of ImageWatermark class
