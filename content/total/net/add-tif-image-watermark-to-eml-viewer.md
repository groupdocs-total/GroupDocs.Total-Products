...
############################# Head ############################
head_title: "Add TIF Image Watermark to EML Viewer in C# .NET"
head_description: "C# .NET API to add TIF image watermark into an email message (EML) and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add TIF Image Watermark to EML Viewer"
description: "Insert TIF or any other image watermark into email message files (EML) quite easily and accurately using GroupDocs.Total suite of documents automation APIs for C# .NET applications."
...
steps:
    ...
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/net/) makes it easy for developers to integrate TIF image watermark into email message documents (EML) using a few lines of C# .NET code.
