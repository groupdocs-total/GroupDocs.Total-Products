...
############################# Head ############################
head_title: "Add Multiple Digital Signatures to XLS Viewer in .NET"
head_description: "Sign Excel spreadsheet (XLS) file with multiple digital signature types (Barcode, Image, Metadata, QR-Code, Stamp, Text, Form Field) in C# .NET applications."

############################# Header ############################
title: "Add Multiple Signatures to XLS Viewer"
description: "Sign Excel spreadsheet (XLS) formats with different digital signature types (Barcode, Image, Metadata, QR-Code, Stamp, Text, Form Field). View the signed file in HTML, Image or PDF viewer in .NET (C#, ASP.NET, VB.NET, .NET Core) applications."
...
steps:
    enable: true
    title_left: "Put multiple signatures to XLS in .NET"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/net/) makes it easy for developers to insert multiple digital signatures to Excel (XLS) worksheets by adding a few lines of C# .NET code.
    ...
    code: |
        ```cs
        // Digitally sign Excel Worksheet (XLS) file with multiple signatures in .NET
