...
############################# Head ############################
head_title: "Add JPE Image Watermark to OneNote Viewer in C# .NET"
head_description: "C# .NET API to add JPE image watermark into Microsoft OneNote (ONE) and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add JPE Image Watermark to OneNote Viewer"
description: "Insert JPE or any other image watermark into Microsoft OneNote files (ONE) quite easily and accurately using GroupDocs.Total suite of documents automation APIs for C# .NET applications."
...
steps:
    enable: true
    title_left: "Adding image watermark to ONE file in .NET"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/net/) makes it easy for developers to integrate JPE image watermark into Microsoft OneNote documents (ONE) using a few lines of C# .NET code.

        *   Instantiate Watermarker with input ONE file
    ...
    code: |
        ```cs
        // Add watermark to OneNote (ONE) file using GroupDocs.Watermark API
        ...
        // View watermarked OneNote ONE file using GroupDocs.Viewer API
