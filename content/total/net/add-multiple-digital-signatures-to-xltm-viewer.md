...
############################# Head ############################
head_title: "Add Multiple Digital Signatures to XLTM Viewer in .NET"
head_description: "Sign Excel spreadsheet (XLTM) formats file with multiple digital signature types (Barcode, Image, Metadata, QR-Code, Stamp, Text, Form Field) in C# .NET applications."

############################# Header ############################
title: "Add Multiple Signatures to XLTM Viewer"
description: "Sign Excel spreadsheet (XLTM) formats with different digital signature types (Barcode, Image, Metadata, QR-Code, Stamp, Text, Form Field). View the signed file in HTML, Image or PDF viewer in .NET (C#, ASP.NET, VB.NET, .NET Core) applications."
...
steps:
    enable: true
    title_left: "Put multiple signatures to XLTM in .NET"
    content_left: |
    ...
    code: |
        ```cs
        // Digitally sign XLTM file with multiple signatures in .NET
