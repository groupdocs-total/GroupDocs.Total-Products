...
############################# Head ############################
head_title: "Add JPE Image Watermark to MHTML Viewer in C# .NET"
head_description: "C# .NET API to add JPE image watermark into a web page archive format (MHTML) and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add JPE Image Watermark to MHTML Viewer"
description: "Insert JPE or any other image watermark into a web page archive format (MHTML) quite easily and accurately using GroupDocs.Total suite of documents automation APIs for C# .NET applications."
...
steps:
    enable: true
    title_left: "Adding image watermark to MHTML file in .NET"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/net/) makes it easy for developers to integrate JPE image watermark into a web page archive format (MHTML) using a few lines of C# .NET code.

        *   Instantiate Watermarker with input MHTML file
    ...
    code: |
        ```cs
        // Add watermark to MHTML file using GroupDocs.Watermark API
