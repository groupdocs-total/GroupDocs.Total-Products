...
############################# Head ############################
head_title: "Add Multiple Digital Signatures to Presentation Viewer in .NET"
head_description: "Sign PowerPoint presentations file with multiple digital signature types (Barcode, Image, Metadata, QR-Code, Stamp, Text, Form Field) in C# .NET applications."

############################# Header ############################
title: "Add Multiple Signatures to Presentation Viewer"
description: "Sign PowerPoint presentation file formats with different digital signature types (Barcode, Image, Metadata, QR-Code, Stamp, Text, Form Field). View the signed file in HTML, Image or PDF viewer in .NET (C#, ASP.NET, VB.NET, .NET Core) applications."
...
steps:
    enable: true
    title_left: "Put multiple signatures to presentations in .NET"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/net/) makes it easy for developers to insert multiple digital signatures to PowerPoint presentation file formats by adding a few lines of C# .NET code.
    ...
    code: |
        ```cs
        // Digitally sign PPTX file with multiple signatures in .NET
