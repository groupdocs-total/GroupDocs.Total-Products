...
############################# Head ############################
head_title: "Add Metadata Signatures to POTM Viewer in C# .NET"
head_description: "Add digital metadata signatures to PowerPoint template (POTM) in C# .NET applications. View the signed file in HTML, Image or PDF viewer using GroupDocs.Total for .NET APIs."

############################# Header ############################
title: "Add Metadata Signatures to .NET POTM Viewer"
description: "Add digital metadata signatures to PowerPoint template (POTM) files. View the signed file in HTML, Image or PDF viewer using GroupDocs.Total APIs for .NET (C#, ASP.NET, VB.NET, .NET Core) applications."
...
steps:
    enable: true
    title_left: "Adding metadata signatures to POTM in .NET"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/net/) makes it easy for developers to digitally sign PowerPoint template (POTM) files with metadata signatures using a few lines of C# .NET code.
    ...
    code: |
        ...
        // Instantiate Signature with input POTM file
