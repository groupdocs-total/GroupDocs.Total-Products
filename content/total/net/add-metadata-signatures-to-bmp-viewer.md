...
############################# Head ############################
head_title: "Add Metadata Signatures to BMP Viewer in C# .NET"
head_description: "Add digital metadata signatures to BMP image file format in C# .NET applications. View the signed file in HTML, Image or PDF viewer using GroupDocs.Total for .NET APIs."

############################# Header ############################
title: "Add Metadata Signatures to .NET BMP Viewer"
description: "Add digital metadata signatures to BMP image file format. View the signed file in HTML, Image or PDF viewer using GroupDocs.Total APIs for .NET (C#, ASP.NET, VB.NET, .NET Core) applications."
...
steps:
    ...
    code: |
        ...
        // Instantiate Signature with input BMP file
