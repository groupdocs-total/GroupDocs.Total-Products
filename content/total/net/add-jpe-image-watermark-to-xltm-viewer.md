...
############################# Head ############################
head_title: "Add JPE Image Watermark to XLTM Viewer in C# .NET"
head_description: "C# .NET API to add JPE image watermark into Excel spreadsheet (XLTM) formats and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add JPE Image Watermark to XLTM Viewer"
description: "Insert JPE or any other image watermark into Excel spreadsheet (XLTM) formats quite easily and accurately using GroupDocs.Total suite of documents automation APIs for C# .NET applications."
