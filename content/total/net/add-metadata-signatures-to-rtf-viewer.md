...
############################# Head ############################
head_title: "Add Metadata Signatures to RTF Viewer in C# .NET"
head_description: "Add digital metadata signatures to Rich Text Format (RTF) documents in C# .NET applications. View the signed file in HTML, Image or PDF viewer using GroupDocs.Total for .NET APIs."

############################# Header ############################
title: "Add Metadata Signatures to .NET RTF Viewer"
description: "Add digital metadata signatures to Rich Text Format (RTF) files. View the signed file in HTML, Image or PDF viewer using GroupDocs.Total APIs for .NET (C#, ASP.NET, VB.NET, .NET Core) applications."
...
steps:
    enable: true
    title_left: "Adding metadata signatures to RTF files in .NET"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/net/) makes it easy for developers to digitally sign Rich Text Format (RTF) documents with metadata signatures using a few lines of C# .NET code.
