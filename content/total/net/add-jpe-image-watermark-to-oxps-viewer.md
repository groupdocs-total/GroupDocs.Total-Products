...
############################# Head ############################
head_title: "Add JPE Image Watermark to OXPS Viewer in C# .NET"
head_description: "C# .NET API to add JPE image watermark into an Open XML Paper Specification file (OXPS) and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add JPE Image Watermark to OXPS Viewer"
description: "Insert JPE or any other image watermark into an Open XML Paper Specification file (OXPS) quite easily and accurately using GroupDocs.Total suite of documents automation APIs for C# .NET applications."
...
steps:
    ...
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/net/) makes it easy for developers to integrate JPE image watermark into an Open XML Paper Specification file (OXPS) using a few lines of C# .NET code.
