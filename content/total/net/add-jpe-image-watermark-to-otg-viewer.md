...
############################# Head ############################
head_title: "Add JPE Image Watermark to OTG Viewer in C# .NET"
head_description: "C# .NET API to add JPE image watermark into an OpenDocument drawing template file (OTG) and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add JPE Image Watermark to OTG Viewer"
description: "Insert JPE or any other image watermark into an OpenDocument drawing template file (OTG) quite easily and accurately using GroupDocs.Total suite of documents automation APIs for C# .NET applications."
...
steps:
    enable: true
    title_left: "Adding image watermark to OTG file in .NET"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/net/) makes it easy for developers to integrate JPE image watermark into an OpenDocument drawing template file (OTG) using a few lines of C# .NET code.

        *   Instantiate Watermarker with input OTG file
    ...
    code: |
        ```cs
        // Add watermark to OTG file using GroupDocs.Watermark API
