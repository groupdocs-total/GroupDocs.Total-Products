...
############################# Head ############################
head_title: "Add JPG Image Watermark to XLTM Viewer in C# .NET"
head_description: "C# .NET API to add JPG image watermark into Excel spreadsheet (XLTM) formats and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add JPG Image Watermark to XLTM Viewer"
description: "Insert JPG or any other image watermark into Excel spreadsheet (XLTM) formats quite easily and accurately using GroupDocs.Total suite of documents automation APIs for C# .NET applications."
