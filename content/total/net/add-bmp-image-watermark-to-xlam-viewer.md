...
############################# Head ############################
head_title: "Add BMP Image Watermark to XLAM Viewer in C# .NET"
head_description: "C# .NET API to add BMP image watermark into Excel spreadsheet (XLAM) formats and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add BMP Image Watermark to XLAM Viewer"
description: "Insert BMP or any other image watermark into Excel spreadsheet (XLAM) formats quite easily and accurately using GroupDocs.Total suite of documents automation APIs for C# .NET applications."
...
steps:
    ...
    code: |
        ```cs
        // Add watermark to Excel worksheet (XLAM) file using GroupDocs.Watermark API
        // Instantiate Watermarker with input XLAM document
