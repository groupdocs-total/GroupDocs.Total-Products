...
############################# Head ############################
head_title: "Add Metadata Signatures to OTP Viewer in C# .NET"
head_description: "Add digital metadata signatures to an OpenDocument presentation template file (OTP) in C# .NET applications. View the signed file in HTML, Image or PDF viewer using GroupDocs.Total for .NET APIs."

############################# Header ############################
title: "Add Metadata Signatures to .NET OTP Viewer"
description: "Add digital metadata signatures to an OpenDocument presentation template file (OTP). View the signed file in HTML, Image or PDF viewer using GroupDocs.Total APIs for .NET (C#, ASP.NET, VB.NET, .NET Core) applications."
...
steps:
    enable: true
    title_left: "Adding metadata signatures to OTP in .NET"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/net/) makes it easy for developers to digitally sign an OpenDocument presentation template file (OTP) with metadata signatures using a few lines of C# .NET code.
        ...
        *   Instantiate one or more <mark>**PresentationMetadataSignature**</mark> objects and add them into <mark>**MetadataSignOptions**</mark> to metadata signatures collection (<mark>**Signatures**</mark>) via <mark>**Add**</mark> or <mark>**AddRange**</mark> method.
    ...
    code: |
        ```cs
        // Add metadata signatures to presentations using GroupDocs.Signature API
        // Instantiate Signature with input OTP file
