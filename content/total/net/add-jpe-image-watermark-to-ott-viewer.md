...
############################# Head ############################
head_title: "Add JPE Image Watermark to OTT Viewer in C# .NET"
head_description: "C# .NET API to add JPE image watermark into an OpenDocument template file (OTT) and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add JPE Image Watermark to OTT Viewer"
description: "Insert JPE or any other image watermark into an OpenDocument template file (OTT) quite easily and accurately using GroupDocs.Total suite of documents automation APIs for C# .NET applications."
...
steps:
    enable: true
    title_left: "Adding image watermark to OTT file in .NET"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/net/) makes it easy for developers to integrate JPE image watermark into an OpenDocument template file (OTT) using a few lines of C# .NET code.

        *   Instantiate Watermarker with input OTT file
    ...
    code: |
        ```cs
        // Add watermark to OTT file using GroupDocs.Watermark API
        // Instantiate Watermarker with input OTT document
        using (Watermarker watermarker = new Watermarker("input.ott"))
          {
            // Use JPE watermark image path as constructor parameter of ImageWatermark class
        ...
        // View watermarked OTT file using GroupDocs.Viewer API
