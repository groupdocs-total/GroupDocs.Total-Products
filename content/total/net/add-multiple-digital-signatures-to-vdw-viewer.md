...
############################# Head ############################
head_title: "Add Multiple Digital Signatures to VDW Viewer in .NET"
head_description: "Sign Microsoft Visio Graphics Service (VDW) file with multiple digital signature types (Barcode, Image, Metadata, QR-Code, Stamp, Text, Form Field) in C# .NET applications."

############################# Header ############################
title: "Add Multiple Signatures to VDW Viewer"
description: "Sign Microsoft Visio Graphics Service (VDW) files with different digital signature types (Barcode, Image, Metadata, QR-Code, Stamp, Text, Form Field). View the signed file in HTML, Image or PDF viewer in .NET (C#, ASP.NET, VB.NET, .NET Core) applications."
...
steps:
    enable: true
    title_left: "Put multiple signatures to VDW in .NET"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/net/) makes it easy for developers to insert multiple digital signatures to Microsoft Visio Graphics Service (VDW) documents by adding a few lines of C# .NET code.
    ...
    code: |
        ```cs
        // Digitally sign VDW file with multiple signatures in .NET
        ...
        using (Signature signature = new Signature("input.vdw"))
          {
            ...
            signature.Sign("signed.vdw", options);
