...
############################# Head ############################
head_title: "Add JP2 Image Watermark to PPTM Viewer in C# .NET"
head_description: "C# .NET API to add JP2 image watermark into PowerPoint presentation (PPTM) and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add JP2 Image Watermark to PPTM Viewer"
description: "Insert JP2 or any other image watermark into PowerPoint presentation (PPTM) files quite easily and accurately using GroupDocs.Total suite of documents automation APIs for C# .NET applications."
...
steps:
    ...
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/net/) makes it easy for developers to integrate JP2 image watermark into PowerPoint presentation (PPTM) file format using a few lines of .NET code.
