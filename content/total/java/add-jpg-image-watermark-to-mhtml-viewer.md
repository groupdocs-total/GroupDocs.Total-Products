...
############################# Head ############################
head_title: "Add JPG Image Watermark to MHTML Viewer in Java"
head_description: "Java API to add JPG image watermark into a web page archive format (MHTML) and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add JPG Image Watermark to MHTML Viewer"
description: "Add JPG or other types of image watermarks into a web page archive format (MHTML) on any position with adjustable size and orientation using GroupDocs.Total suite of documents automation APIs for java applications."
...
steps:
    ...
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/java/) makes it easy for developers to integrate JPG image watermark into a web page archive format (MHTML) using a few lines of Java code.
