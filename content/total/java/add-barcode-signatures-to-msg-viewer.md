...
############################# Head ############################
head_title: "Add Barcode Signatures to MSG Viewer in Java"
head_description: "Add 60+ digital barcode signatures to Microsoft Outlook Email (MSG) and 100+ other file formats. View the signed file in HTML using GroupDocs.Total for Java APIs."

############################# Header ############################
title: "Add Barcode Signatures to MSG Viewer"
description: "Digitally sign and secure Microsoft Outlook Email files (MSG) by adding 60+ barcode signature types in your Java applications using GroupDocs.Total APIs."
...
steps:
    enable: true
    title_left: "Adding barcode signatures to MSG in Java"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/java/) makes it easy for developers to digitally sign Microsoft Outlook Email documents (MSG) with barcode signatures using a few lines of Java code.
    ...
    code: |
        ...
        Signature signature = new Signature("input.msg");
        try 
          {
            ...
            // sign the document
            signature.sign("output.msg", signOptions);
