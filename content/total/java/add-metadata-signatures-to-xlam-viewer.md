...
############################# Head ############################
head_title: "Add Metadata Signatures to XLAM Viewer in Java"
head_description: "Add digital metadata signatures to Excel spreadsheet (XLAM) formats in Java applications. View the signed file in HTML, Image or PDF viewer using GroupDocs.Total for Java APIs."

############################# Header ############################
title: "Add Metadata Signatures to Java XLAM Viewer"
description: "Add digital metadata signatures to Excel spreadsheet (XLAM) formats. View the signed file in HTML, Image or PDF viewer using GroupDocs.Total APIs for Java applications."
...
steps:
    enable: true
    title_left: "Adding metadata signatures to XLAM in Java"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/java/) makes it easy for developers to digitally sign Excel worksheets with metadata signatures using a few lines of Java code.
        ...
        *   Instantiate one or more <mark>**SpreadsheetMetadataSignature**</mark> objects and add them into <mark>**MetadataSignOptions**</mark> to metadata signatures collection (<mark>**getSignatures**</mark>) via <mark>**Add**</mark> or <mark>**AddRange**</mark> method.
    ...
    code: |
        ...
        // Instantiate Signature with input XLAM file
        Signature signature = new Signature("input.xlam");
          {
            ...
            signature.Sign("output.xlam", options);
          }
