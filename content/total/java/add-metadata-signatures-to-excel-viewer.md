...
############################# Head ############################
head_title: "Add Metadata Signatures to Excel Viewer in Java"
head_description: "Add digital metadata signatures to Excel spreadsheets in Java applications. View the signed file in HTML, Image or PDF viewer using GroupDocs.Total for Java APIs."

############################# Header ############################
title: "Add Metadata Signatures to Java Excel Viewer"
description: "Add digital metadata signatures to Excel spreadsheet formats. View the signed file in HTML, Image or PDF viewer using GroupDocs.Total APIs for Java applications."
...
steps:
    enable: true
    title_left: "Adding metadata signatures to Excel in Java"
    content_left: |
