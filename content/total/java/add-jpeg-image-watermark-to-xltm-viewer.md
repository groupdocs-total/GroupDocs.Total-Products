...
############################# Head ############################
head_title: "Add JPEG Image Watermark to XLTM Viewer in Java"
head_description: "Java API to add JPEG image watermark into Excel spreadsheet (XLTM) formats and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add JPEG Image Watermark to XLTM Viewer"
description: "Add JPEG or other types of image watermarks into Excel spreadsheet (XLTM) formats on any position with adjustable size and orientation using GroupDocs.Total suite of documents automation APIs for java applications."
