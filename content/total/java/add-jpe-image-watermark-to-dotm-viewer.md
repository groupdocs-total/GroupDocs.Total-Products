...
############################# Head ############################
head_title: "Add JPE Image Watermark to Word DOTM Viewer in Java"
head_description: "Java API to add JPE image watermark into Word processing documents (DOTM) and 90+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add JPE Image Watermark to DOTM Viewer"
description: "Add JPE or any image watermark into Word processing document formats on any position with adjustable size and orientation using GroupDocs.Total suite of documents automation APIs for java applications."
...
steps:
    enable: true
    title_left: "Adding image watermark to DOTM file in Java"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/java/) makes it easy for developers to integrate JPE image watermark into Word (DOTM) documents using a few lines of Java code.
    ...
    code: |
        ```cs
        // Add watermark to Word Processing (DOTM) file using GroupDocs.Watermark API
        // Instantiate FileInputStream Object with input file
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-word-o"
          title: " About Word DOTM File Format"
          content: |
