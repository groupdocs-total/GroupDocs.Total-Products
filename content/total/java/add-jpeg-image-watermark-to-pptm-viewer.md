...
############################# Head ############################
head_title: "Add JPEG Image Watermark to PPTM Viewer in Java"
head_description: "Java API to add JPEG image watermark into PowerPoint presentation (PPTM) and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add JPEG Image Watermark to PPTM Viewer"
description: "Add JPEG or other types of image watermarks into PowerPoint PowerPoint presentation (PPTM) files on any position with adjustable size and orientation using GroupDocs.Total suite of documents automation APIs for java applications."
...
steps:
    ...
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/java/) makes it easy for developers to integrate JPEG image watermark into PowerPoint presentation (PPTM) file format using a few lines of .NET code.
