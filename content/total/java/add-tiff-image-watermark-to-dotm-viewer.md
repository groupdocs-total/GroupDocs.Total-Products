...
############################# Head ############################
head_title: "Add TIFF Image Watermark to Word DOTM Viewer in Java"
head_description: "Java API to add TIFF image watermark into Word processing documents (DOTM) and 90+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add TIFF Image Watermark to DOTM Viewer"
...
steps:
    ...
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/java/) makes it easy for developers to integrate TIFF image watermark into Word (DOTM) documents using a few lines of Java code.
