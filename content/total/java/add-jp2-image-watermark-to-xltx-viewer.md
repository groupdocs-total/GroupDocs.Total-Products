...
############################# Head ############################
head_title: "Add JP2 Image Watermark to XLTX Viewer in Java"
head_description: "Java API to add JP2 image watermark into Excel spreadsheet (XLTX) formats and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add JP2 Image Watermark to XLTX Viewer"
description: "Add JP2 or other types of image watermarks into Excel spreadsheet (XLTX) formats on any position with adjustable size and orientation using GroupDocs.Total suite of documents automation APIs for java applications."
