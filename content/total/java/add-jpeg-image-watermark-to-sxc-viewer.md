...
############################# Head ############################
head_title: "Add JPEG Image Watermark to SXC Viewer in Java"
head_description: "Java API to add JPEG image watermark into Rich Text Format (SXC) documents and 90+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add JPEG Image Watermark to SXC Viewer"
description: "Add JPEG or any image watermark into Rich Text Format (SXC) files on any position with adjustable size and orientation using GroupDocs.Total suite of documents automation APIs for java applications."
...
steps:
    ...
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/java/) makes it easy for developers to integrate JPEG image watermark into Rich Text Format (SXC) documents using a few lines of Java code.
