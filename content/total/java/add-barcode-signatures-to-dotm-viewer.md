...
############################# Head ############################
head_title: "Add Barcode Signatures to DOTM Viewer in Java"
head_description: "Add 60+ digital barcode signatures to Word processing documents (DOTM) and 100+ other file formats. View the signed file in HTML using GroupDocs.Total for Java APIs."

############################# Header ############################
title: "Add Barcode Signatures to DOTM Viewer"
description: "Digitally sign and secure Word processing (DOTM) file format by adding 60+ barcode signature types in your Java applications using GroupDocs.Total APIs."
...
steps:
    enable: true
    title_left: "Adding barcode signatures to DOTM in Java"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/java/) makes it easy for developers to digitally sign Word (DOTM) documents with barcode signatures using a few lines of Java code.
        ...
        try 
          {
            ...
            // sign the document
            signature.sign("output.dotm", signOptions);
