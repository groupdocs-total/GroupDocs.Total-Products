...
############################# Head ############################
head_title: "Add Barcode Signatures to FODP Viewer in Java"
head_description: "Add 60+ digital barcode signatures to an OpenDocument Flat XML Presentation file (FODP) and 100+ other file formats. View the signed file in HTML using GroupDocs.Total for Java APIs."

############################# Header ############################
title: "Add Barcode Signatures to FODP Viewer"
description: "Digitally sign and secure an OpenDocument Flat XML Presentation file (FODP) by adding 60+ barcode signature types in your Java applications using GroupDocs.Total APIs."
...
steps:
    enable: true
    title_left: "Adding barcode signatures to FODP in Java"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/java/) makes it easy for developers to digitally sign an OpenDocument Flat XML Presentation file (FODP) with barcode signatures using a few lines of Java code.
    ...
    code: |
        ...
        Signature signature = new Signature("input.fodp");
        try 
          {
            ...
            // sign the document
            signature.sign("output.fodp", signOptions);
