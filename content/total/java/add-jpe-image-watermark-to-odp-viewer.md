...
############################# Head ############################
head_title: "Add JPE Image Watermark to ODP Viewer in Java"
head_description: "Java API to add JPE image watermark into an OpenDocument presentation file (ODP) and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add JPE Image Watermark to ODP Viewer"
description: "Add JPE or other types of image watermarks into an OpenDocument presentation file (ODP) on any position with adjustable size and orientation using GroupDocs.Total suite of documents automation APIs for java applications."
...
steps:
    ...
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/java/) makes it easy for developers to integrate JPE image watermark into an OpenDocument presentation file (ODP) using a few lines of Java code.
