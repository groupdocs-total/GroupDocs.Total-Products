...
############################# Head ############################
head_title: "Add JPE Image Watermark to Word DOT Viewer in Java"
head_description: "Java API to add JPE image watermark into Word processing documents (DOT) and 90+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add JPE Image Watermark to DOT Viewer"
...
steps:
    enable: true
    title_left: "Adding image watermark to DOT file in Java"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/java/) makes it easy for developers to integrate JPE image watermark into Word (DOT) documents using a few lines of Java code.
    ...
    code: |
        ```cs
        // Add watermark to Word Processing (DOT) file using GroupDocs.Watermark API
        // Instantiate FileInputStream Object with input file
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-word-o"
          title: " About Word DOT File Format"
          content: |
