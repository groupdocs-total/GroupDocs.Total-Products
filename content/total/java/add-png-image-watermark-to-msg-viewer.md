...
############################# Head ############################
head_title: "Add PNG Image Watermark to MSG Viewer in Java"
head_description: "Java API to add PNG image watermark into Microsoft Outlook Email (MSG) and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add PNG Image Watermark to MSG Viewer"
description: "Add PNG or other types of image watermarks into Microsoft Outlook Email files (MSG) on any position with adjustable size and orientation using GroupDocs.Total suite of documents automation APIs for java applications."
...
steps:
    ...
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/java/) makes it easy for developers to integrate PNG image watermark into Microsoft Outlook Email documents (MSG) using a few lines of Java code.
