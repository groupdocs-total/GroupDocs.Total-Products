...
############################# Head ############################
head_title: "Add JPE Image Watermark to SXC Viewer in Java"
head_description: "Java API to add JPE image watermark into Rich Text Format (SXC) documents and 90+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add JPE Image Watermark to SXC Viewer"
description: "Add JPE or any image watermark into Rich Text Format (SXC) files on any position with adjustable size and orientation using GroupDocs.Total suite of documents automation APIs for java applications."
...
steps:
    enable: true
    title_left: "Adding image watermark to SXC files Java"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/java/) makes it easy for developers to integrate JPE image watermark into Rich Text Format (SXC) documents using a few lines of Java code.
    ...
    code: |
        ```cs
        // Add watermark to (SXC) file using GroupDocs.Watermark API
        // Instantiate FileInputStream Object with input file
