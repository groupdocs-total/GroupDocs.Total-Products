...
############################# Head ############################
head_title: "Add Metadata Signatures to DOCM Viewer in Java"
head_description: "Add digital metadata signatures to Word processing documents (DOCM) in Java applications. View the signed file in HTML, Image or PDF viewer using GroupDocs.Total for Java APIs."

############################# Header ############################
title: "Add Metadata Signatures to Java DOCM Viewer"
description: "Add digital metadata signatures to Word processing (DOCM) file format. View the signed file in HTML, Image or PDF viewer using GroupDocs.Total APIs for Java applications."
...
steps:
    enable: true
    title_left: "Adding metadata signatures to DOCM in Java"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/java/) makes it easy for developers to digitally sign Word (DOCM) documents with metadata signatures using a few lines of Java code.
