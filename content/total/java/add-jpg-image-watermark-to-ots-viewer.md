...
############################# Head ############################
head_title: "Add JPG Image Watermark to OTS Viewer in Java"
head_description: "Java API to add JPG image watermark into an OpenDocument Spreadsheet template file (OTS) and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add JPG Image Watermark to OTS Viewer"
description: "Add JPG or other types of image watermarks into an OpenDocument Spreadsheet template file (OTS) on any position with adjustable size and orientation using GroupDocs.Total suite of documents automation APIs for java applications."
...
steps:
    ...
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/java/) makes it easy for developers to integrate JPG image watermark into an OpenDocument Spreadsheet template file (OTS) using a few lines of Java code.
