...
############################# Head ############################
head_title: "Add PNG Image Watermark to XLAM Viewer in Java"
head_description: "Java API to add PNG image watermark into Excel spreadsheet (XLAM) formats and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add PNG Image Watermark to XLAM Viewer"
description: "Add PNG or other types of image watermarks into Excel spreadsheet (XLAM) formats on any position with adjustable size and orientation using GroupDocs.Total suite of documents automation APIs for java applications."
