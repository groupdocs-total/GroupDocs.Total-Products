...
############################# Head ############################
head_title: "Add JP2 Image Watermark to OTT Viewer in Java"
head_description: "Java API to add JP2 image watermark into an OpenDocument template file (OTT) and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add JP2 Image Watermark to OTT Viewer"
description: "Add JP2 or other types of image watermarks into an OpenDocument template file (OTT) on any position with adjustable size and orientation using GroupDocs.Total suite of documents automation APIs for java applications."
...
steps:
    ...
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/java/) makes it easy for developers to integrate JP2 image watermark into an OpenDocument template file (OTT) using a few lines of Java code.
