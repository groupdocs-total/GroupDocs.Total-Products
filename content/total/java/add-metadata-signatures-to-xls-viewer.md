...
############################# Head ############################
head_title: "Add Metadata Signatures to XLS Viewer in Java"
head_description: "Add digital metadata signatures to Excel spreadsheet (XLS) in Java applications. View the signed file in HTML, Image or PDF viewer using GroupDocs.Total for Java APIs."

############################# Header ############################
title: "Add Metadata Signatures to Java XLS Viewer"
description: "Add digital metadata signatures to Excel spreadsheet (XLS) formats. View the signed file in HTML, Image or PDF viewer using GroupDocs.Total APIs for Java applications."
...
steps:
    enable: true
    title_left: "Adding metadata signatures to XLS in Java"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/java/) makes it easy for developers to digitally sign Excel (XLS) worksheets with metadata signatures using a few lines of Java code.
    ...
    code: |
        ...
        // Instantiate Signature with input XLS file
