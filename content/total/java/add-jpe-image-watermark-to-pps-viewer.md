...
############################# Head ############################
head_title: "Add JPE Image Watermark to PPS Viewer in Java"
head_description: "Java API to add JPE image watermark into PowerPoint Slide Show (PPS) format and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add JPE Image Watermark to PPS Viewer"
description: "Add JPE or other types of image watermarks into PowerPoint Slide Show (PPS) format on any position with adjustable size and orientation using GroupDocs.Total suite of documents automation APIs for java applications."
...
steps:
    enable: true
    title_left: "Adding image watermark to PPS file in Java"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/java/) makes it easy for developers to integrate JPE image watermark into PowerPoint (PPS) file format using a few lines of .NET code.
    ...
    code: |
        ```cs
        // Add watermark to (PPS) file using GroupDocs.Watermark API
        // Instantiate FileInputStream Object with input file
