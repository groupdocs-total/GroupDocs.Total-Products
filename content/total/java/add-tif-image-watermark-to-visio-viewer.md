...
############################# Head ############################
head_title: "Add TIF Image Watermark to Visio Viewer in Java"
head_description: "Java API to add TIF image watermark into Microsoft Visio Drawing files and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add TIF Image Watermark to Visio Viewer"
description: "Add TIF or other types of image watermarks into Microsoft Visio Drawing files on any position with adjustable size and orientation using GroupDocs.Total suite of documents automation APIs for java applications."
...
steps:
    ...
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/java/) makes it easy for developers to integrate TIF image watermark into Microsoft Visio Drawing documents using a few lines of Java code.
