...
############################# Head ############################
head_title: "Add Metadata Signatures to XLSM Viewer in Java"
head_description: "Add digital metadata signatures to Excel spreadsheet (XLSM) formats in Java applications. View the signed file in HTML, Image or PDF viewer using GroupDocs.Total for Java APIs."

############################# Header ############################
title: "Add Metadata Signatures to Java XLSM Viewer"
description: "Add digital metadata signatures to Excel spreadsheet (XLSM) formats. View the signed file in HTML, Image or PDF viewer using GroupDocs.Total APIs for Java applications."
...
steps:
    enable: true
    title_left: "Adding metadata signatures to XLSM in Java"
    content_left: |
    ...
    code: |
        ...
        // Instantiate Signature with input XLSM file
