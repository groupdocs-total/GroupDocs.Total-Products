...
############################# Head ############################
head_title: "Add JPE Image Watermark to XLAM Viewer in Java"
head_description: "Java API to add JPE image watermark into Excel spreadsheet (XLAM) formats and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add JPE Image Watermark to XLAM Viewer"
description: "Add JPE or other types of image watermarks into Excel spreadsheet (XLAM) formats on any position with adjustable size and orientation using GroupDocs.Total suite of documents automation APIs for java applications."
...
steps:
    enable: true
    title_left: "Adding image watermark to XLAM file in Java"
    content_left: |
    ...
    code: |
        ```cs
        // Add watermark to (XLAM) file using GroupDocs.Watermark API
        // Instantiate FileInputStream Object with input file
