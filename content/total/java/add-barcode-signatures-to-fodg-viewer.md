...
############################# Head ############################
head_title: "Add Barcode Signatures to FODG Viewer in Java"
head_description: "Add 60+ digital barcode signatures to an OpenDocument graphic file (FODG) and 100+ other file formats. View the signed file in HTML using GroupDocs.Total for Java APIs."

############################# Header ############################
title: "Add Barcode Signatures to FODG Viewer"
description: "Digitally sign and secure an OpenDocument graphic file (FODG) by adding 60+ barcode signature types in your Java applications using GroupDocs.Total APIs."
...
steps:
    enable: true
    title_left: "Adding barcode signatures to FODG in Java"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/java/) makes it easy for developers to digitally sign an OpenDocument graphic file (FODG) with barcode signatures using a few lines of Java code.
    ...
    code: |
        ...
        Signature signature = new Signature("input.fodg");
        try 
          {
            ...
            // sign the document
            signature.sign("output.fodg", signOptions);
