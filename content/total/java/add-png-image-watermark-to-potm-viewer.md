...
############################# Head ############################
head_title: "Add PNG Image Watermark to POTM Viewer in Java"
head_description: "Java API to add PNG image watermark into PowerPoint template (POTM) and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add PNG Image Watermark to POTM Viewer"
description: "Add PNG or other types of image watermarks into PowerPoint template (POTM) files on any position with adjustable size and orientation using GroupDocs.Total suite of documents automation APIs for java applications."
...
steps:
    ...
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/java/) makes it easy for developers to integrate PNG image watermark into PowerPoint template (POTM) file format using a few lines of .NET code.
