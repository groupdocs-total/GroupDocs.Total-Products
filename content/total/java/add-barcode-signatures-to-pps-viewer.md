...
############################# Head ############################
head_title: "Add Barcode Signatures to PPS Viewer in Java"
head_description: "Add 60+ digital barcode signatures to PowerPoint Slide Show (PPS) format and 100+ other file formats. View the signed file in HTML using GroupDocs.Total for Java APIs."

############################# Header ############################
title: "Add Barcode Signatures to PPS Viewer"
description: "Digitally sign and secure PowerPoint Slide Show (PPS) format by adding 60+ barcode signature types in your Java applications using GroupDocs.Total APIs."
...
steps:
    enable: true
    title_left: "Adding barcode signatures to PPS in Java"
    content_left: |
        [GroupDocs.Total](https://products.groupdocs.com/total/java/) makes it easy for developers to digitally sign PowerPoint (PPS) files with barcode signatures using a few lines of Java code.
        ...
        try 
          {
            ...
            // sign the document
            signature.sign("output.pps", signOptions);
