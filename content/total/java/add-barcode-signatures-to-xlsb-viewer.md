...
############################# Head ############################
head_title: "Add Barcode Signatures to XLSB Viewer in Java"
head_description: "Add 60+ digital barcode signatures to Excel spreadsheet (XLSB) formats and 100+ other file formats. View the signed file in HTML using GroupDocs.Total for Java APIs."

############################# Header ############################
title: "Add Barcode Signatures to XLSB Viewer"
description: "Digitally sign and secure Excel spreadsheet (XLSB) formats by adding 60+ barcode signature types in your Java applications using GroupDocs.Total APIs."
...
steps:
    enable: true
    title_left: "Adding barcode signatures to XLSB in Java"
    content_left: |
        ...
        try 
          {
            ...
            // sign the document
            signature.sign("output.xlsb", signOptions);
