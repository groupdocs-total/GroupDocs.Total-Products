...
############################# Head ############################
head_title: "Add TIF Image Watermark to XLSX Viewer in Java"
head_description: "Java API to add TIF image watermark into Excel spreadsheet (XLSX) and 100+ other file formats using GroupDocs.Total suite of documents automation APIs."

############################# Header ############################
title: "Add TIF Image Watermark to XLSX Viewer"
description: "Add TIF or other types of image watermarks into Excel spreadsheet (XLSX) formats on any position with adjustable size and orientation using GroupDocs.Total suite of documents automation APIs for java applications."
